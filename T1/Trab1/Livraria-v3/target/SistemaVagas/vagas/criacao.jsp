    ...
    <fmt:bundle basename="messages">
        ...
        <div class="formulario">
            <form id="form" action="/SistemaVagas/vaga/criarVaga" method="post">
                ...
                <input type="number" id="remuneracao" name="remuneracao" value="${sessionScope.remuneracao != null ? sessionScope.remuneracao : ''}" required><br>
                ...
                <input type="date" id="dataLimite" name="dataLimite" required value="${sessionScope.dataLimite != null ? sessionScope.dataLimite : ''}"><br>
