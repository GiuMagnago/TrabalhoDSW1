        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                ...
                <body>
                    ...
                    <c:if test="${not empty sessionScope.erroAtualizarEmpresa}">
                        <script>
                            alert("${sessionScope.erroAtualizarEmpresa}");
                        </script>
                        <c:remove var="erroAtualizarEmpresa" scope="session" />
                    </c:if>
                    ...
                    <fmt:bundle basename="messages">
                        ...
                        <div class="formulario">
                            <form id="forms" action="/SistemaVagas/empresa" method="POST">
                                <input type="hidden" name="empresa" value="${sessionScope.empresa}" />
                                <h3>
